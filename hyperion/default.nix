...

{
  imports = [
    ./disko.nix
    ({
      _module.args.disks = [ "/dev/disk/by-id/nvme-Micron_3500_MTFDKBA512TGD_252751714B26_1" "/dev/disk/by-id/nvme-Micron_3500_MTFDKBA512TGD_252751714B64_1" ];
    })
  ...
  systemd.services.ztrim = {
    startAt = "weekly";
    script = ''
      /run/current-system/sw/bin/zpool trim hyperion
    '';
  };
